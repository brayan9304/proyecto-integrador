(function() {
    ...
    MaterialPiDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'Material', 'SessionMaterial'];

    function MaterialPiDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, Material, SessionMaterial) {
        var vm = this;
        ...
        vm.save = save;
        vm.sessionmaterials = SessionMaterial.query();
